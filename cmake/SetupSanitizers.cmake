...
if(LW_USE_ADDRESS_SANITIZER)
    if(MSVC)
        ...
        set(LW_ADDRESS_SANITIZER_LIBS "-lasan")
        check_linker_flag(CXX "${LW_ADDRESS_SANITIZER_LIBS}" HAS_ADDRESS_SANITIZER_ASAN)
        if (NOT HAS_ADDRESS_SANITIZER_ASAN)
            message(WARNING "libasan is not available. Address sanitizer might not work")
        else()
...
if(LW_USE_THREAD_SANITIZER)
    set(LW_THREAD_SANITIZER_LIBS "-ltsan")
    check_linker_flag(CXX "${LW_THREAD_SANITIZER_LIBS}" HAS_THREAD_SANITIZER_TSAN)
    if (NOT HAS_THREAD_SANITIZER_TSAN)
        message(WARNING "libtsan is not available. Thread sanitizer might not work")
    else()
